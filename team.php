                            ...
                            <div class="row">
                                <div class="col-xl-5 col-lg-5">
                                    <div class="inner_team-img mb-30 mb-lg-0">
                                        <img src="assets/images/team/priyabrata2.jpg" alt="" class="tp_fade_right">
                                        <img src="assets/images/team/shape.png" alt="" class="inner_team-img-shape tp_fade_bottom">
                                    </div>
                                </div>
                                <div class="col-xl-7 col-lg-7">
                               <div class="inner_team-content mb-lg-0 mb-140" style="font-family: 'Poppins', sans-serif;">
  <h2 class="inner_team-content-title tp_has_text_reveal_anim" 
      style="font-size: 28px; font-weight: 700; color: #111; margin-bottom: 15px;">
    COO. Mr. Priyabrata Pattanaik
  </h2>

  <h6 class="inner_team-content-subtitle tp_has_text_reveal_anim" 
      style="font-size: 22px; font-weight: 500; color: #444; margin-bottom: 25px;">
    A visionary leader with a strong foundation in Engineering, Management, and Sales.
  </h6>

  <p class="tp_fade_bottom" 
     style="font-size: 18px; line-height: 1.8; color: #555; margin-bottom: 18px;">
    Mr. Priyabrata Pattanaik brings over a decade of multidisciplinary experience across engineering innovation, business strategy, and operational excellence. His ability to blend technical expertise with strategic foresight has been instrumental in driving sustainable growth and efficiency across multiple domains.
  </p>

  <p class="tp_fade_bottom" 
     style="font-size: 18px; line-height: 1.8; color: #555;">
    As Chief Operating Officer, he plays a key role in shaping organizational culture, optimizing processes, and building high-performing teams that deliver results. His hands-on approach and deep understanding of market dynamics have positioned the company for long-term success in a competitive landscape.
  </p>

  <div class="inner_team-signature tp_fade_bottom" style="margin-top: 30px;">
    <img src="assets/images/team/signature.png" alt="" style="max-width: 200px;">
  </div>
</div>
