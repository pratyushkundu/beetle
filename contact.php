                                ...
                                <div class="col-lg-4 col-md-6 mb-30 tp_fade_left" data-fade-from="left" data-delay=".6">
                                    <div class="contact-item">
                                        ...
                                        <div class="contact-content">
                                            ...
                                            <a href="tel:+91 9078064335">+91 9078064335</a>
    ...
    <div class="row">
        ...
        <div class="col-12">
            <div class="contact-form-item">
                <select name="subject" class="subject-option has-nice-select mb-25" required>
                    <option value="">Select Subject</option>
                    <option value="Software Services">Regarding Software Services</option>
                    <option value="Core Engineering Services">Regarding Core Engineering Services</option>
                    <option value="Our Product">Regarding Our Product</option>
                </select>
            </div>
        </div>
        <div class="col-12">
